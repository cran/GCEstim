...
Consider `dataThesis` (see ["Generalized Maximum Entropy framework"](V2_GME_framework.html#Examples) and [Generalized Cross Entropy framework"](V3_GCE_framework.html#Examples)). 
